        ...
        <>
            <div className=' border-b border-neutral-900 pb-4'>
                ...
                className=" flex justify-center items-center lg:m-8 m-4">
                    <div style={{ backgroundColor: "#171721 " }} className=" lg:w-[55%] w-full border border-gray-600 rounded-xl lg:p-10 px-3 mt-4 py-5 shadow-[0_0_10px_rgba(75,20,130,0.8)]">
                        ...
                        <form ref={form} action="" onSubmit={sendEmail}>
                            ...
                            <button className="flex items-center justify-center flex-1 w-[100%] p-3 bg-transparent rounded-xl border border-gray-600 outline-none text-xl mt-6 font-bold bg-gradient-to-r from-pink-500 to-purple-900">Send</button>
                        </form>
                    </div>
                </motion.div>
            </div>
